  ...
  return (
    <section id="about" className={`py-16 ${typography.tracking.tight} bg-black/50 ${className}`}>
      <div className={`container mx-auto ${spacing.container.padding}`}>
        <div className={`${spacing.container.maxWidth.md} mx-auto space-y-8 md:space-y-12 px-4`}>
          <p className={`${typography.fontSize.xl} md:${typography.fontSize['2xl']} leading-relaxed ${colors.text.white} ${typography.tracking.tight} text-center`}>
